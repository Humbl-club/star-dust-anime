            ...
            <div className="flex flex-col items-center gap-6">
              <div className="relative">
                ...
                <div className="absolute -top-2 -right-2 w-6 h-6 bg-accent rounded-full flex items-center justify-center">
                  <Brain className="w-3 h-3 text-accent-foreground animate-bounce" />
                </div>
              </div>
              <div className="space-y-4">
                <h2 className="text-3xl font-bold text-gradient-primary">Unlock AI Recommendations!</h2>
                <p className="text-muted-foreground leading-relaxed">
                  Verify your email to access personalized anime & manga recommendations powered by AI.
                </p>
