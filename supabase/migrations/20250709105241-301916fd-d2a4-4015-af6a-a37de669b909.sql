...
-- Drop existing initialize_user_atomic function to recreate with new return type
DROP FUNCTION IF EXISTS public.initialize_user_atomic(uuid) CASCADE;

-- Create new initialize_user_atomic function with welcome animation failsafe logic
