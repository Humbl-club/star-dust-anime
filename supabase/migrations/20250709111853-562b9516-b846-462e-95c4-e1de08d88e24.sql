...
-- 1. Update initialize_user_atomic function to remove points logic
...
-- 2. Update get_user_gamification_summary to remove points
...
-- 3. Drop unused points-related tables
DROP TABLE IF EXISTS daily_activities CASCADE;
DROP TABLE IF EXISTS user_points CASCADE;

-- 4. Drop unused points-related functions
