...
-- 2. Create new simplified initialize_user_atomic function
...
-- 3. Update get_user_gamification_summary to remove points
...
-- 4. Drop unused points-related tables
DROP TABLE IF EXISTS daily_activities CASCADE;
DROP TABLE IF EXISTS user_points CASCADE;

-- 5. Drop unused points-related functions
