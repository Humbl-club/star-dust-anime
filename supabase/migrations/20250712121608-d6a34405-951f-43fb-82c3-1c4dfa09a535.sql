...
-- Drop ALL existing service role policies first to avoid conflicts
...
DROP POLICY IF EXISTS "Service role manages genres" ON genres;
DROP POLICY IF EXISTS "Service role manages studios" ON studios;
DROP POLICY IF EXISTS "Service role manages authors" ON authors;
DROP POLICY IF EXISTS "Service role manages title_genres" ON title_genres;
DROP POLICY IF EXISTS "Service role manages title_studios" ON title_studios;
DROP POLICY IF EXISTS "Service role manages title_authors" ON title_authors;
...
-- Drop old individual service role policies
