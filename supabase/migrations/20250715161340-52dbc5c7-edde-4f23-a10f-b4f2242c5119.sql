-- Fix the 500 error and clean up obsolete functions

-- First, fix the token generation issue in handle_new_user function
...
-- Remove obsolete functions that are no longer needed
...
-- Clean up any remaining conflicting triggers
