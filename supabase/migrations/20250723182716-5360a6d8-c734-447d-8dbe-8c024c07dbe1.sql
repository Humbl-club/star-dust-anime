-- Create partitioned archive table with proper structure
...
BEGIN
  ...
  INSERT INTO public.cron_job_logs_archive (
    id, job_name, status, executed_at, completed_at, details, error_message, created_at
  )
  SELECT 
    id, job_name, status, executed_at, 
    NULL as completed_at, -- Map to new column structure
