-- 1.5 Enable RLS on All Tables with Policies (Security Fix)
...
ALTER TABLE public.edge_function_dashboard ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.edge_function_test_results ENABLE ROW LEVEL SECURITY;
